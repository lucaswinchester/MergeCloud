...
const seedProducts = [
  // ── Residential ──
  {
    ...
    specifications: { connectivity: "5G", management: "Remote", type: "Router" },
    retailPrice: 595,
  ...
  },
  {
    ...
    specifications: { connectivity: "4G", management: "Remote", type: "Router" },
    retailPrice: 395,
    retailLeasePrice: 14.99,
    wholesalePrice: 290,
    wholesaleLeasePrice: 10.99,
  ...
  },
  {
    ...
    specifications: { connectivity: "4G", management: "Remote", type: "Hotspot" },
    retailPrice: 159.99,
    retailLeasePrice: 14.99,
    wholesalePrice: 110,
    wholesaleLeasePrice: 10.99,
  ...
  },
  {
    ...
    specifications: { connectivity: "5G", management: "Remote", type: "Outdoor Router", rating: "IP67" },
    retailPrice: 795,
  ...
  // ── Business ──
  {
    ...
    specifications: { connectivity: "Starlink + 5G", type: "Bonded Bundle" },
    retailPrice: 1898,
  ...
  },
  {
    ...
    specifications: { connectivity: "Starlink + 5G Failover", type: "Backup Bundle" },
    retailPrice: 1898,
    retailLeasePrice: 500,
    wholesalePrice: 1500,
    wholesaleLeasePrice: 400,
  ...
  },
  {
    ...
    imageUrl: "/images/IQMC_Outdoor.png",
    features: ["Starlink Enterprise Hardware", "5G IQMC Hardware", "Automatic Failover"],
    specifications: { connectivity: "5G + Starlink Failover", type: "Backup Bundle" },
    retailPrice: 1898,
    retailLeasePrice: 500,
    wholesalePrice: 1500,
    wholesaleLeasePrice: 400,
  ...
  // ── IoT ──
  {
    ...
    specifications: { lens: "Single Telephoto", power: "Solar", ptz: "Yes" },
    retailPrice: 1898,
    retailLeasePrice: 500,
    wholesalePrice: 1400,
  ...
  },
  {
    ...
    specifications: { lens: "Dual (Wide + Telephoto)", power: "Solar", ptz: "Yes" },
    retailPrice: 1898,
    retailLeasePrice: 500,
    wholesalePrice: 1400,
    wholesaleLeasePrice: 380,
  ...
  },
  {
    ...
    specifications: { connectivity: "5G", tracking: "GPS + Breadcrumb", safety: "Fall Detection + Geofencing" },
    retailPrice: 1898,
    retailLeasePrice: 500,
    wholesalePrice: 1400,
    wholesaleLeasePrice: 380,
